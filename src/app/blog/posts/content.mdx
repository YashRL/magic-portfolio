...
`const social = [
    {
      name: "GitHub",
      icon: "github",
      link: "https://github.com/YashRL/nextjs-starter",
    },
    {
      name: "Email",
      icon: "email",
...
`const home = {
    label: "Home",
    title: "Yash Rawal's Portfolio",
    description: "Portfolio website showcasing my work as a AIML Engineer",
    headline: <>AIML Engineer and builder</>,
    subline: (
      <>
        I'm Yash, a AIML Engineer at <InlineCode>FLY</InlineCode>, where I craft intuitive
